...
export default function SettingsScreen() {
  ...
  const { sleepFadeDuration, setSleepFadeDuration, notificationsEnabled, setNotificationsEnabled, replayGainMode, setReplayGainMode, queueSyncEnabled, setQueueSyncEnabled, autoplayQueueEnabled, setAutoplayQueueEnabled, libraryAutoSyncEnabled, setLibraryAutoSyncEnabled } = useUIStore();
